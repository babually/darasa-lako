...
import {
	...
	SheetHeader,
	SheetTitle,
} from "@darasa-lako/ui/components/sheet";
import { Skeleton } from "@darasa-lako/ui/components/skeleton";
import {
	Tooltip,
	TooltipContent,
	TooltipTrigger,
} from "@darasa-lako/ui/components/tooltip";
import { useIsMobile } from "@darasa-lako/ui/hooks/use-mobile";
import { cn } from "@darasa-lako/ui/lib/utils";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: Setting sidebar state cookie for server-side recovery
