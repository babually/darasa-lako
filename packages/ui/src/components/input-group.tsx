...
import { Textarea } from "@darasa-lako/ui/components/textarea";
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useKeyWithClickEvents: onClick is helper to focus adjacent input
		// biome-ignore lint/a11y/noStaticElementInteractions: div is intentionally interactive to proxy focus to sibling input
		<div
